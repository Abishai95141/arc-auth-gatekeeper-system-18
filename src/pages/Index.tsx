    ...
    <div className="flex min-h-screen flex-col">
      <header className="border-b bg-card">
        <div className="container flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">Builders Arc</span>
          </div>
      ...
      <main className="flex-1">
        <section className="bg-gradient-to-b from-background to-muted py-20 text-center">
          <div className="container px-4">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/signup">
                <Button size="lg" className="bg-arc-accent hover:bg-arc-accent/80">
                  Apply to Join
                </Button>
              </Link>
              <Link to="/login">
        ...
        <section className="py-16">
          <div className="container px-4">
            <h2 className="mb-12 text-center text-3xl font-bold">Why Join Builders Arc?</h2>
            
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-lg border bg-card p-6">
                <div className="mb-4 h-12 w-12 rounded-full bg-arc-primary/10 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-arc-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                </div>
                <h3 className="mb-2 text-xl font-bold">Collaborative Community</h3>
              ...
              <div className="rounded-lg border bg-card p-6">
                ...
                <h3 className="mb-2 text-xl font-bold">Monthly Tech Talks</h3>
                <p className="text-muted-foreground">
              ...
              <div className="rounded-lg border bg-card p-6">
                ...
                <h3 className="mb-2 text-xl font-bold">Project Incubation</h3>
                <p className="text-muted-foreground">
        ...
        <section className="bg-muted py-16">
          <div className="container px-4">
            <div className="mx-auto max-w-3xl rounded-xl bg-card p-8 shadow-lg">
              <h2 className="mb-4 text-center text-2xl font-bold">Ready to join the community?</h2>
